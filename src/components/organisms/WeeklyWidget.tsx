...
const WeeklyWidget = () => {
    return (
        <div className='WeeklyWidget rounded-2xl w-full h-fit bg-[#3B3B3B] flex flex-row items-center xl:gap-16 gap-10  xl:p-16 p-10 text-white mt-36'>
            ...
            <div className='flex  flex-col text-left gap-5 flex-1 '>
                <h2 className={`${WorkSans.className} xl:text-5xl text-4xl w-10/12 leading-tight`}>
                    Join our weekly digest
                </h2>
                <p className={`${WorkSansRegular.className} xl:text-2xl text-xl w-10/12 mb-5 leading-normal`}>
