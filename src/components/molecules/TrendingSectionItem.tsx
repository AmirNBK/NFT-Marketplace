    ...
    return (
        <div className='TrendingSectionItem w-full'>
            <div className="flex flex-col text-2xl leading-8 text-white rounded-3xl w-full">
                ...
                <div className="flex xl:gap-4 lg:gap-7 gap-3 mt-4 font-bold text-center capitalize whitespace-nowrap leading-[160%] w-full justify-between">
                    <Image
                        unoptimized
                        loading="lazy"
                        src={images[1]}
                    ...
                    <Image
                        ...
                        loading="lazy"
                        src={images[2]}
                        className="rounded-3xl w-1/3 h-[100px] object-cover xl:block block"
                        alt='image'
                    />
